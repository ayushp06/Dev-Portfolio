    ...
    <section className="min-h-screen flex items-center justify-center relative bg-slate-900">
      <div className="container mx-auto px-4 z-10 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-4xl md:text-5xl mb-8 mt-4 text-white font-semibold h-16 md:h-20 flex items-center justify-center gap-2 w-full text-center translate-x-2 md:translate-x-3">
